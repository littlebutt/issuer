...
def test_new_comment():
    ...
    res = client.post(
        "/comment/new",
        json={"issue_code": issue_code, "content": "This is a comment."},
        cookies=cookie,
    )
    assert res.json()["success"] is True
...
def test_fold_comment():
    ...
    res = client.post(
        "/comment/fold", json={"comment_code": comment_code}, cookies=cookie
    )
    assert res.json()["success"] is True
    comments = list_issue_comment_by_issue(issue_code)
...
def test_list_comment():
    ...
    res = client.get(
        f"/comment/list_comments_by_code?issue_code={issue_code}",
        cookies=cookie,
    )
